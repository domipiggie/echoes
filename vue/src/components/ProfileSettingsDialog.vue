...
const loadUserData = async () => {
  try {
    ...
    // Itt kéne lekérni a felhasználó adatait az API-ból
    // Példa:
    // const response = await axios.get(`${API_CONFIG.BASE_URL}/userInfo/${userStore.getUserID()}`, {
    ...
    // Ideiglenes megoldás, amíg nincs API végpont:
    username.value = 'Felhasználó';
    email.value = 'felhasznalo@example.com';
    bio.value = 'Ez egy rövid bemutatkozás...';
  } catch (error) {
    console.error('Hiba a felhasználói adatok betöltésekor:', error);
    errorMessage.value = 'Nem sikerült betölteni a felhasználói adatokat.';
  } finally {
...
const saveUserData = async () => {
  try {
    ...
    // Itt kéne elküldeni a felhasználó adatait az API-nak
    // Példa:
    ...
    // const response = await axios.put(`${API_CONFIG.BASE_URL}/userInfo/${userStore.getUserID()}`, formData, {
    //   headers: { 
